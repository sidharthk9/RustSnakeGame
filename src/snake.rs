...
impl Snake {
    pub fn new_snake(x: i32, y: i32) -> Snake {
        //The "body" is a linked list. Heh.
        let mut body: LinkedList<Block> = LinkedList::new();

        //Appends two blocks to the "body"
    ...
    pub fn draw_body(&self, context: &Context, gfx: &mut G2d) {
